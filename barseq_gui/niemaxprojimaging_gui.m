function niemaxprojimaging_gui(app, cyclename, chseq, tformch, pausetime, posinfo, tform, srcpath, destpath)
    ...
    %%
    app.MessageTextArea.Value= ['cyclename=', cyclename , ' srcpath= ', srcpath ' destpath= ', destpath, 'chseq=', chseq  ];
    ...
    if ~exist('tform','var')
        app.WarningTextArea.Value=[app.WarningTextArea.Value(:)', {sprintf('No tform. Using empty list.')}];
        tform=[];
    end
